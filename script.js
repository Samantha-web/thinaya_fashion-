...
const defaultProducts = [
  ...
  { id: 17, title: "Navy Blue Office Saree", category: "Office Saree", type: "For Sale", price: "RS. 35,000.00", image: `${IMG}1599643478518-a784e5dc4c8f?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1599643478518-a784e5dc4c8f?auto=format&fit=crop&w=500&q=80`, extraImgs[0], extraImgs[3]), video: "", status: "Available" },
  { id: 18, title: "Beige Cotton Office Saree", category: "Office Saree", type: "For Sale", price: "RS. 28,000.00", image: `${IMG}1539008835657-9e8e9680c956?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1539008835657-9e8e9680c956?auto=format&fit=crop&w=500&q=80`, extraImgs[1], extraImgs[5]), video: "", status: "Available" },
  { id: 19, title: "Grey Office Wear Saree", category: "Office Saree", type: "For Rent", price: "RS. 15,000.00", image: `${IMG}1490481651871-ab68de25d43d?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1490481651871-ab68de25d43d?auto=format&fit=crop&w=500&q=80`, extraImgs[2], extraImgs[6]), video: "", status: "Available" },
  { id: 20, title: "Pastel Blue Office Saree", category: "Office Saree", type: "For Rent", price: "RS. 18,000.00", image: `${IMG}1469334031218-e382a71b716b?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1469334031218-e382a71b716b?auto=format&fit=crop&w=500&q=80`, extraImgs[4], extraImgs[7]), video: "", status: "Available" },
  { id: 21, title: "White Office Formal Saree", category: "Office Saree", type: "For Sale", price: "RS. 32,000.00", image: `${IMG}1556905055-8f358a7a47b2?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1556905055-8f358a7a47b2?auto=format&fit=crop&w=500&q=80`, extraImgs[2], extraImgs[5]), video: "", status: "Available" },
  { id: 22, title: "Black Office Party Saree", category: "Office Saree", type: "For Sale", price: "RS. 38,000.00", image: `${IMG}1524504388940-b1c1722653e1?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1524504388940-b1c1722653e1?auto=format&fit=crop&w=500&q=80`, extraImgs[1], extraImgs[6]), video: "", status: "Sold" },
  { id: 23, title: "Mint Green Office Saree", category: "Office Saree", type: "For Rent", price: "RS. 16,000.00", image: `${IMG}1564257631407-4deb1f99d992?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1564257631407-4deb1f99d992?auto=format&fit=crop&w=500&q=80`, extraImgs[0], extraImgs[3], extraImgs[7]), video: "", status: "Rented" },
  { id: 24, title: "Striped Office Saree", category: "Office Saree", type: "For Rent", price: "RS. 14,000.00", image: `${IMG}1544005313-94ddf0286df2?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1544005313-94ddf0286df2?auto=format&fit=crop&w=500&q=80`, extraImgs[4], extraImgs[5]), video: "", status: "Available" },
  // Lehenga Collection
  { id: 25, title: "Crimson Red Bridal Lehenga", category: "Lehenga", type: "For Sale", price: "RS. 280,000.00", image: `${IMG}1599643478518-a784e5dc4c8f?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1599643478518-a784e5dc4c8f?auto=format&fit=crop&w=500&q=80`, extraImgs[0], extraImgs[2], extraImgs[4]), video: "uploads/videos/01.mp4", status: "Available" },
  { id: 26, title: "Pastel Pink Lehenga Choli", category: "Lehenga", type: "For Rent", price: "RS. 55,000.00", image: `${IMG}1610030469983-98e550d6193c?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1610030469983-98e550d6193c?auto=format&fit=crop&w=500&q=80`, extraImgs[1], extraImgs[5]), video: "", status: "Available" },
  { id: 27, title: "Gold Embroidered Party Lehenga", category: "Lehenga", type: "For Sale", price: "RS. 175,000.00", image: `${IMG}1524504388940-b1c1722653e1?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1524504388940-b1c1722653e1?auto=format&fit=crop&w=500&q=80`, extraImgs[3], extraImgs[6]), video: "", status: "Available" },
  { id: 28, title: "Navy Blue Lehenga Set", category: "Lehenga", type: "For Rent", price: "RS. 48,000.00", image: `${IMG}1583391733958-6c68b6b02bc3?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1583391733958-6c68b6b02bc3?auto=format&fit=crop&w=500&q=80`, extraImgs[0], extraImgs[7]), video: "", status: "Available" },
  // Bridal Designer Collection
  { id: 29, title: "Designer Bridal Gown with Train", category: "Bridal Designer", type: "For Sale", price: "RS. 350,000.00", image: `${IMG}1591604021695-0c69b7c05981?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1591604021695-0c69b7c05981?auto=format&fit=crop&w=500&q=80`, extraImgs[2], extraImgs[4], extraImgs[6]), video: "uploads/videos/01.mp4", status: "Available" },
  { id: 30, title: "Handcrafted Bridal Sharara", category: "Bridal Designer", type: "For Rent", price: "RS. 75,000.00", image: `${IMG}1600093463592-8e36ae95ef56?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1600093463592-8e36ae95ef56?auto=format&fit=crop&w=500&q=80`, extraImgs[1], extraImgs[5]), video: "", status: "Available" },
  { id: 31, title: "Ivory Designer Bridal Ensemble", category: "Bridal Designer", type: "For Sale", price: "RS. 420,000.00", image: `${IMG}1566174053879-31528523f8ae?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1566174053879-31528523f8ae?auto=format&fit=crop&w=500&q=80`, extraImgs[0], extraImgs[3], extraImgs[7]), video: "uploads/videos/01.mp4", status: "Sold" },
  { id: 32, title: "Rose Gold Designer Lehenga", category: "Bridal Designer", type: "For Rent", price: "RS. 95,000.00", image: `${IMG}1595844730298-b960fa25fa21?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1595844730298-b960fa25fa21?auto=format&fit=crop&w=500&q=80`, extraImgs[2], extraImgs[5]), video: "", status: "Available" },
  // Additional Wedding Saree
  { id: 33, title: "Ruby Red Wedding Saree", category: "Wedding Saree", type: "For Sale", price: "RS. 195,000.00", image: `${IMG}1595844730298-b960fa25fa21?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1595844730298-b960fa25fa21?auto=format&fit=crop&w=500&q=80`, extraImgs[1], extraImgs[4]), video: "", status: "Available" },
  { id: 34, title: "Gold Tissue Wedding Saree", category: "Wedding Saree", type: "For Rent", price: "RS. 58,000.00", image: `${IMG}1610030469983-98e550d6193c?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1610030469983-98e550d6193c?auto=format&fit=crop&w=500&q=80`, extraImgs[0], extraImgs[6]), video: "", status: "Available" },
  { id: 35, title: "Peach Silk Wedding Saree", category: "Wedding Saree", type: "For Sale", price: "RS. 165,000.00", image: `${IMG}1591604021695-0c69b7c05981?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1591604021695-0c69b7c05981?auto=format&fit=crop&w=500&q=80`, extraImgs[3], extraImgs[5]), video: "", status: "Available" },
  { id: 36, title: "Kandyan Bridal Saree", category: "Wedding Saree", type: "For Rent", price: "RS. 62,000.00", image: `${IMG}1524504388940-b1c1722653e1?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1524504388940-b1c1722653e1?auto=format&fit=crop&w=500&q=80`, extraImgs[2], extraImgs[7]), video: "", status: "Available" },
  // Additional Gowns
  { id: 37, title: "White Evening Gown", category: "Gown", type: "For Sale", price: "RS. 85,000.00", image: `${IMG}1566174053879-31528523f8ae?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1566174053879-31528523f8ae?auto=format&fit=crop&w=500&q=80`, extraImgs[1], extraImgs[3]), video: "", status: "Available" },
  { id: 38, title: "Red Velvet Reception Gown", category: "Gown", type: "For Rent", price: "RS. 38,000.00", image: `${IMG}1583391733958-6c68b6b02bc3?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1583391733958-6c68b6b02bc3?auto=format&fit=crop&w=500&q=80`, extraImgs[0], extraImgs[4]), video: "", status: "Available" },
  { id: 39, title: "Mermaid Style Sequin Gown", category: "Gown", type: "For Sale", price: "RS. 120,000.00", image: `${IMG}1490481651871-ab68de25d43d?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1490481651871-ab68de25d43d?auto=format&fit=crop&w=500&q=80`, extraImgs[2], extraImgs[5]), video: "", status: "Sold" },
  { id: 40, title: "Embroidered Ball Gown", category: "Gown", type: "For Rent", price: "RS. 45,000.00", image: `${IMG}1469334031218-e382a71b716b?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1469334031218-e382a71b716b?auto=format&fit=crop&w=500&q=80`, extraImgs[1], extraImgs[6]), video: "", status: "Available" },
  // Additional Party Wear
  { id: 41, title: "Sequin Party Saree", category: "Party Wear", type: "For Sale", price: "RS. 45,000.00", image: `${IMG}1600093463592-8e36ae95ef56?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1600093463592-8e36ae95ef56?auto=format&fit=crop&w=500&q=80`, extraImgs[0], extraImgs[3]), video: "", status: "Available" },
  { id: 42, title: "Printed Cocktail Saree", category: "Party Wear", type: "For Rent", price: "RS. 20,000.00", image: `${IMG}1556905055-8f358a7a47b2?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1556905055-8f358a7a47b2?auto=format&fit=crop&w=500&q=80`, extraImgs[1], extraImgs[5]), video: "", status: "Available" },
  { id: 43, title: "Floral Party Lehenga", category: "Party Wear", type: "For Sale", price: "RS. 65,000.00", image: `${IMG}1564257631407-4deb1f99d992?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1564257631407-4deb1f99d992?auto=format&fit=crop&w=500&q=80`, extraImgs[2], extraImgs[4]), video: "", status: "Available" },
  { id: 44, title: "Burgundy Party Gown", category: "Party Wear", type: "For Rent", price: "RS. 28,000.00", image: `${IMG}1539008835657-9e8e9680c956?auto=format&fit=crop&w=500&q=80`, images: makeImages(`${IMG}1539008835657-9e8e9680c956?auto=format&fit=crop&w=500&q=80`, extraImgs[0], extraImgs[7]), video: "", status: "Available" },
];
...
function showCheckoutModal() {
  const cart = getCart();
  if (cart.length === 0) { showToast('Your cart is empty!', 'fa-exclamation-triangle'); return; }
  ...
  const itemsHtml = cart.map(item => {
    const pn = Math.round(parsePriceNum(item.price));
    total += pn * item.qty;
    return `<div class="checkout-item">
      <img src="${getProductImages(item)[0]}" alt="${item.title}" onerror="this.style.display='none'">
      <div class="checkout-item-info"><h4>${item.title}</h4><p>${item.price} × ${item.qty}</p></div>
      <span>LKR ${(pn * item.qty).toLocaleString()}</span>
    </div>`;
  }).join('');
  ...
  overlay.innerHTML = `
    <div class="checkout-content">
      <div class="checkout-header">
        <h2><i class="fa-solid fa-file-invoice" style="color:var(--gold);"></i> Purchase Order</h2>
        <button class="checkout-close" id="checkout-close">&times;</button>
      </div>
      <div class="checkout-body">
        <div class="checkout-items">${itemsHtml}</div>
        <div class="checkout-total-row"><span>Total</span><span>LKR ${total.toLocaleString()}</span></div>
        <div class="checkout-form">
          <h4>Customer Details</h4>
          <input type="text" id="checkout-name" placeholder="Your Full Name" required>
          <input type="tel" id="checkout-phone" placeholder="WhatsApp Number (e.g. 94771234567)" required>
        </div>
      </div>
      <div class="checkout-footer">
        <button class="btn" id="place-order-btn"><i class="fa-brands fa-whatsapp" style="font-size:1.1rem;"></i> Send Order via WhatsApp</button>
      </div>
    </div>`;

  overlay.classList.add('show');
  document.getElementById('checkout-close').onclick = () => overlay.classList.remove('show');
...
function placeOrder() {
  ...
  if (!name) { showToast('Please enter your name', 'fa-exclamation-triangle'); return; }
  if (!phone) { showToast('Please enter your WhatsApp number', 'fa-exclamation-triangle'); return; }
  ...
  let total = 0;
  cart.forEach(item => {
    total += Math.round(parsePriceNum(item.price)) * item.qty;
  });

  const date = new Date().toLocaleDateString('en-GB');

  let msg = `🧾 *PURCHASE ORDER - Thinaya Fashion*\n\n`;
  msg += `*Customer:* ${name}\n`;
  msg += `*Phone:* ${phone}\n`;
  msg += `*Date:* ${date}\n\n`;
  msg += `*Items:*\n`;
  cart.forEach((item, i) => {
    const pn = Math.round(parsePriceNum(item.price));
    msg += `${i + 1}. ${item.title} × ${item.qty} = LKR ${(pn * item.qty).toLocaleString()}\n`;
  });
  msg += `\n*Total: LKR ${total.toLocaleString()}*\n\n`;
  msg += `_Thank you for choosing Thinaya Fashion_`;

  const WHATSAPP_NUMBER = '94713207190';
  ...
  showToast('Order sent via WhatsApp!', 'fa-check-circle');
}

function initCheckout() {
  const btn = document.querySelector('.cart-footer .btn');
  if (btn) btn.onclick = (e) => { e.preventDefault(); showCheckoutModal(); };
}
...
function renderCartItems() {
  ...
  cart.forEach(item => {
    const priceNum = Math.round(parsePriceNum(item.price));
